...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h5 class="text-center"><p></p>Usuarios registrados para préstamos</h5>
            <div class="row">
                <div class="col-lg-12">
                    <button class="btn btn-primary mb-2" type="button" data-toggle="modal" data-target="#nuevoEstudiante"><i class="fas fa-user-plus"></i> Ingresar usuario</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-black" id="my-modal-title">Registro de usuario</h5>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="codigo" class="form-control" type="text" name="codigo" required placeholder="(*) Codigo del usuario">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="nombre" class="form-control" type="text" name="nombre" required placeholder="(*) Nombre y apellido">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="carrera">Correo electrónico</label>
                                    <input id="carrera" class="form-control" type="text" name="carrera" required placeholder="(*) Correo electrónico">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
